...
const CertificatePageBackground = styled.div`
  ...
  background: linear-gradient(
    149deg,
    rgba(8, 212, 223, 1) 0%,
    rgba(58, 122, 226, 1) 51%,
    rgba(244, 7, 254, 1) 100%
  );
  min-height: 100vh;
  padding-top: 2rem;
  padding-bottom: 4rem;
...
function App() {
  ...
  function handleDownloadButtonClick() {
    toast(
      "Puedes realizar una captura de pantalla para guardar tu certificado. 📷",
      {
        duration: 6000,
        style: {
          borderRadius: "10px",
        ...
        <Atropos>
          <CertificateContainer>
            ...
            <CertificateDescription>
              POR HABER SIDO PARTE DE LA 1RA CONFERENCIA DE PRIVACIDAD DE DATOS
              Y CERTIFICACIÓN CDPSE DE ISACA
            </CertificateDescription>
            <CertificateFooter>
              <div>
              ...
              <div className="right">
                ...
                <RegularText variant="white">2 de Julio de 2022</RegularText>
              </div>
            </CertificateFooter>
            <SealImage src={seal} />
          </CertificateContainer>
        </Atropos>
        <Button onClick={handleDownloadButtonClick} className="dl-btn" auto>
          ℹ️
        </Button>
      </CertificatePageBackground>
    );
      ...
      <MainPageContainer>
        <TitlesContainer>
          ...
          <Text weight="bold" size="2rem">
            Privacidad de la Data y Certificación CDPSE de ISACA
          </Text>
        </TitlesContainer>
        <StyledForm onSubmit={handleFormSubmit}>
          <Input
            bordered
            label="Por favor, escriba su nombre"
            helperText="*Para mejores resultados, utilice un navegador de escritorio"
            width="100%"
            name="name"
          />
